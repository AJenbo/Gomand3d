...
typedef struct tagD3DAppTextureFormat {
    ...
    int AlphaBPP;       /* number of bits in palette index */
...
typedef struct tagD3DAppInfo {
    ...
    D3DAppTextureFormat     TranspTextureFormat; /* description of transparent format,
                             identical to TextureFormat[CurrTextureFormat] */
	...
	LPDIRECTDRAWSURFACE     lpBackBuffer2;  /*Tim Stretch: back buffer surfacen for triple buffering */
...
typedef struct tagStretchInfo {
	BOOL					bStretch;			//Tim Stretch: stretch blits is enabled                                              for rendering are in ok */
	BOOL					bCanStretch;		//Tim Stretch: card can stretch blit                                                 for rendering are in ok */
	BOOL					bWillStretch;		//Tim Stretch: stretch blits will be enabled                                         for rendering are in ok */
} sStretchInfo;
/*
...
typedef struct tagD3DAppRenderState {
    ...
    TRANSPSTYLE      transparency;  /* enumerated transparency style */
} D3DAppRenderState;
